...
public class CPUChart extends Chart {
	...
	protected void edgeDevicesCpuUsage() {
		...
		if (simulationManager.getScenario().getStringOrchArchitecture().contains("MIST")
			...
			updateSeries(getChart(), "Mist", toArray(currentTime), toArray(mistUsage), SeriesMarkers.NONE, Color.GREEN);
		}
	}
	...
	protected void edgeDataCentersCpuUsage() {
		...
		if (simulationManager.getScenario().getStringOrchArchitecture().contains("EDGE")
			...
			updateSeries(getChart(), "Edge", toArray(currentTime), toArray(edgeUsage), SeriesMarkers.NONE, Color.BLUE);
		}
	}
	...
	protected void cloudCpuUsage() {
		...
		updateSeries(getChart(), "Cloud", toArray(currentTime), toArray(cloudUsage), SeriesMarkers.NONE, Color.RED);
	}
