...
public class WanChart extends Chart {
    ...
    public void update() {
        ...
        updateSeries(getChart(), "WanUp", time, toArray(wanUpUsage), SeriesMarkers.NONE, Color.MAGENTA);
        updateSeries(getChart(), "WanDown", time, toArray(wanDownUsage), SeriesMarkers.NONE, Color.CYAN);
    }
}
